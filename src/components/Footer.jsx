...
export const Footer = () => (
  <footer className="border-t border-[#dfe5dc] bg-[#f8f7f2] px-6 py-10 lg:px-8">
    <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 sm:flex-row sm:items-center">
      ...
      <div className="flex flex-col items-center gap-3 sm:items-start">
        <span className="text-sm font-semibold text-[#18332b]">Connect with us</span>
        <div className="flex items-center gap-3">
          {socialLinks.map((social) => (
            <a
              ...
              className="grid h-9 w-9 place-items-center rounded-full border border-[#dfe5dc] bg-white text-[#557067] transition hover:border-[#18332b] hover:text-[#18332b]"
            >
              {social.icon}
            </a>
          ))}
      ...
      <div className="text-center">
        <p className="text-sm text-[#82948c]">
      ...
      <div className="flex items-center gap-3 sm:flex-col sm:items-end">
        <span className="text-sm font-medium text-[#82948c]">Powered by</span>
        <img 
          src={OweeLogo} 
          alt="Owee Logo" 
